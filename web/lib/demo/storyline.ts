...
export type BeatKind = "intro" | "day" | "how-built" | "outro";
...
// ——— Beat 5 — How this was built (民宿 voice: it's a real prototype) ———
// Authored copy in the guesthouse register. The five substance claims are
// woven into the prose so they read warm, not like a SaaS spec sheet, while
// each remains on-screen text (grep-able): a live SRS engine + rule-based
// grader with 101 tests; Gemini-generated dialogue + per-character TTS voices;
// Lyria music; deployed on Vercel; and that everything just shown runs on that
// same engine.
const HOW_BUILT: StoryBeat = {
  id: "how-built",
  kind: "how-built",
  pipLabel: "Built",
  day: null,
  ...
  titleJa: "舞台裏",
  imageSlot: "05-ladder",
  imageCaption: "The lamp left on in the back room — the workshop behind the inn.",
  narrative: [
    "Before you step out, let me pull back the shōji and show you the back room. None of what you just lived through was a mockup — it is a real working prototype, and every one of those four evenings ran on the same engine you can play in a moment.",
    "The memory at the heart of it is a live SRS engine with a rule-based grader, kept honest by 101 tests — so what comes due, and whether you truly said it, is decided by real code, not a script.",
    "Each evening’s conversation is dialogue generated by Gemini and spoken aloud in per-character TTS voices — that is why Mom sounds like Mom. The music drifting under it all is composed by Lyria. And the whole inn is already deployed on Vercel, lit up and waiting for guests.",
  ],
  callout: [
    "Everything you just saw runs on that same engine — the spaced repetition, the grading, the generated scenes, the voices, the music. The hard part is real and finished; what remains is the ordinary work of accounts and a database.",
  ],
  presenterNote:
    "This is the part the panel should hear: it’s not a slideshow of a future product. It’s the product. Open the door and play it.",
  highlights: [],
};

// ——— Beat 6 — Outro (the pitch) ———
...
// The ordered seven beats: Intro · Day 1 · Day 2 · Day 3 · Day 4 ·
// How it was built · Outro.
